...
namespace SphereMapExample
{
    public class Game1 : Game
    {
        ...
        bool _cpuCalculatedHeightData = true;
        ...
        private Texture2D _sphericalTexture2DHeightMap;
        ...
        private RasterizerState rs_wireframe_cw = new RasterizerState() { FillMode = FillMode.WireFrame, CullMode = CullMode.CullClockwiseFace };
        private RasterizerState rs_solid_cw = new RasterizerState() { FillMode = FillMode.Solid, CullMode = CullMode.CullClockwiseFace };
        private RasterizerState rs_wireframe_ccw = new RasterizerState() { FillMode = FillMode.WireFrame, CullMode = CullMode.CullCounterClockwiseFace };
        private RasterizerState rs_solid_ccw = new RasterizerState() { FillMode = FillMode.Solid, CullMode = CullMode.CullCounterClockwiseFace };
        ...
        public Game1()
        {
            // https://stackoverflow.com/questions/5519328/executing-batch-file-in-c-sharp  ill try to get this working later on.

            //var path = Environment.CurrentDirectory;
            //var cmdpath = Path.Combine(path, "Content", "ShaderCompScript", "CompileShaders.bat");
        ...
        protected override void LoadContent()
        {
            ...
            _sphericalTexture2DEnviromentalMap = Content.Load<Texture2D>("EarthHeightMap1280");  // "hdr_colorful_studio_2k" "schadowplatz_2k" "hdr_royal_esplanade_2k"  "Mercury_Messenger_DEM_Global_665m_1024" "Mars_MGS_MOLA_DEM_mosaic_global_1024" "EarthHeightMap1280"
            _initialLoadedFormat = _sphericalTexture2DEnviromentalMap.Format;

            _sphericalTexture2DHeightMap = Content.Load<Texture2D>("EarthHeightMap1280");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (IsPressedWithDelay(Keys.F8, gameTime))
        ...
        {
            if (_cpuCalculatedHeightData)
                _drawingEffect.CurrentTechnique = _drawingEffect.Techniques["RenderSphereWithCubeMapCpuData"];
            else
            ...
            if (_wireframe)
                GraphicsDevice.RasterizerState = rs_wireframe_ccw;
            else
                GraphicsDevice.RasterizerState = rs_solid_ccw;   //rs_solid;
